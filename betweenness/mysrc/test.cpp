...
int main(int argc, const char* argv[]) {
    ...
    std::string offsetfile = "../data/large-csr-offset.mtx";
    std::string columnfile = "../data/large-csr-indicesweights.mtx";
    // std::string offsetfile = "../data/tiny-csr-offset.mtx";
    // std::string columnfile = "../data/tiny-csr-indicesweights.mtx";
...
std::string offsetfile1 = "../data/small-csr-offset.mtx";
    std::string columnfile1 = "../data/small-csr-indicesweights.mtx";
